...
internal ref struct DnsReader
{
    ...
    public readonly DnsReader GetSubReader(ushort position) => new(_originalBuffer, position, checked((ushort)(_originalBuffer.Length - position)));
    public readonly DnsReader GetSubReader(ushort position, ushort length) => new(_originalBuffer, position, length);
